...
| `template.yaml`           | SAM (CloudFormation) — Lambda + EventBridge schedule + SNS alert topic + three CloudWatch alarms + a log group. `EnableWriteProbe` parameter gates the v1 write canary.                                                                         |
